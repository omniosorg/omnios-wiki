...
commenting-out and options in /etc/ssh/sshd\_config. Also, both
directives MUST be commented out (SunSSH has one uncommented by
default). The OpenSSH package will deliver a file to consult. This file
is the recommended default configuration.

**IMPORTANT NOTE 2 (Thanks Andy Fiddaman):** To continue allowing
connections from SunSSH, please add the following to :

}

If you have ssh service entries in /etc/pam.conf you may need to update
them. For example, Andy needed to''' '''to re-enable their two-factor
authentication.
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,2fb9a48
2fb9a48\]

/ shows omnios-2fb9a48
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,280c743
280c743\]

 shows omnios-280c743
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,cac2b76
cac2b76\]

 shows omnios-cac2b76
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,798601a
798601a\]

 shows omnios-b13298f (driver update only)
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,b13298f
b13298f\]

 shows omnios-b13298f
...
`* The `` pkg(5) variant is now available as of this update.  See the [wiki:ReleaseNotes/r151018 r151018 Release Notes] for details on how to create a DEBUG-kernel alternate boot environment.`

### April 21 2016 Update

illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,aab7656
aab7656\]

 shows omnios-aab7656
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,c91bcdf
c91bcdf\]

 shows omnios-c91bcdf
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,d0a4f2e
d0a4f2e\]

 shows omnios-d0a4f2e
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,5ba982d
5ba982d\]

 shows omnios-8322307 (NOTE: The discrepency is because the tip of the
branch contains a single-package change, not enough to respin illumos.)

`* OpenSSH updated to 7.1p1, including the [wiki:ReleaseNotes/r151016 r151016] method of switching between OpenSSH or SunSSH.  PLEASE READ THE [wiki:ReleaseNotes/r151016 r151016] notes on OpenSSH & SunSSH.`\
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,f090f73
f090f73\]

 shows omnios-f090f73
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,cffff65
cffff65\]

 shows omnios-cffff65

`   - Fix for `[`illumos`` ``6214`](https://www.illumos.org/issues/6214)` which exposed L2ARC users to potential data corruption.`
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,d08e0e5
d08e0e5\]

 shows omnios-d08e0e5
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,7648372
7648372\]

 shows omnios-7648372
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,170cea2
170cea2\]

 shows omnios-170cea2
...
illumos-omnios branch r151014 at \[changeset:core/illumos-omnios,45f3064
45f3064\]

` - `` shows omnios-45f3064`\
` - Last illumos-gate merge was `[`4e90188`](https://github.com/illumos/illumos-gate/commit/4e90188)`.`

r151014 release repository: [1](http://pkg.omniti.com/omnios/r151014/)
...
`* The linked-images IPS Package brand (`“`lipkg`”`).  There is a [wiki:linked_images whole page about linked-images].`

`* The `“`omnios`”` publisher for r151014 (and future releases) now has its package signing policy set to require-signatures.  See the [wiki:SignedPackages] page for more information.  Administrators who [wiki:Upgrade_to_r151014 upgrade] will set this policy themselves as part of the [wiki:Upgrade_to_r151014 documented upgrade process]. New ISO or Kayak installations will have the `“`omnios`”` publisher's policy set.`

`* Kayak servers that install 014 MUST use an 014 miniroot.gz.  This is available where the other media is:  `[`http://omnios.omniti.com/media/miniroot-r151014.gz`](http://omnios.omniti.com/media/miniroot-r151014.gz)
...
`* Faulty TCP maxburst logic fixed for off-link/subnet communication (illumos `[`5295`](http://illumos.org/issues/5295)`).`
...
`* If properly configured, a zone can now run one or more [wiki:VirtualMachinesKVM KVM instances].`
